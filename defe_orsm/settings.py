"""
Django settings for defe_orsm project.
...
SECRET_KEY = 'django-insecure-0#f13um6k6hhhso=qr+h3y3z5fa01#ez98)kbf%szo=mc^%$rs'
...
WSGI_APPLICATION = 'defe_orsm.wsgi.application'
